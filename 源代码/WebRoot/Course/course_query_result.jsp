...
<div id="course_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="courseQueryForm" method="post">
			心理课程编号：<input type="text" class="textbox" id="courseNo" name="courseNo" style="width:110px" />
			心理课程名称：<input type="text" class="textbox" id="courseName" name="courseName" style="width:110px" />
			上课心理辅导老师：<input class="textbox" type="text" id="teacherObj_teacherNo_query" name="teacherObj.teacherNo" style="width: auto"/>
...
<div id="courseEditDiv">
	<form id="courseEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			<span class="label">教学大纲:</span>
			<span class="inputControl">
				<textarea id="course_jxff_edit" name="course.jxff" rows="8" cols="60"></textarea>

			</span>

		</div>
		<div>
			<span class="label">心理课程简介:</span>
			<span class="inputControl">
				<textarea id="course_kcjj_edit" name="course.kcjj" rows="8" cols="60"></textarea>
