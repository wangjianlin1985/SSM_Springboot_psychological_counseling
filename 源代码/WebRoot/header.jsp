...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">心理咨询网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>Student/frontlist">用户</a></li>
                <li><a href="<%=basePath %>ClassInfo/frontlist">班级</a></li> -->
                <li><a href="<%=basePath %>Teacher/frontlist">心理咨询师</a></li>
                <li><a href="<%=basePath %>Course/frontlist">心理课程查询</a></li>
                <li><a href="<%=basePath %>Xiti/frontlist">心理习题练习测试</a></li>
                <li><a href="<%=basePath %>Leaveword/frontlist">问题回复</a></li>
                <li><a href="<%=basePath %>Video/frontlist">心理资料浏览</a></li>

                <li><a href="<%=basePath %>Notice/frontlist">学习天地</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Leaveword/leaveword_studentFrontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我要心理咨询</a></li>
                        <li><a href="<%=basePath %>Leaveword/studentFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的心理咨询</a></li>
