...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>Student/frontlist">用户信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Student/student_frontAdd.jsp" style="display:none;">添加用户</a>
		</ul>
		<div class="row">
			<%
				/*计算起始序号*/
				...
				for(int i=0;i<studentList.size();i++) {
            		...
            		Student student = studentList.get(i); //获取到用户对象
            		String clearLeft = "";
